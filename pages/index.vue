<template>
  <div class="intro py-12 px-8 sm:py-7 sm:px-40">
    ...
    <section class="about pt-10 sm:max-w-3xl font-light">
      ...
      <br />
      <p class="text-[22px]">To Download my Resume <a href="https://github.com/thetejasmagade/thetejasmagade.me/blob/master/Tejas%20Magade%20Resume.pdf" download class="max-w-sm leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#00dc82] to-[#36e4da]">Click Here</a></p>
    </section>
...
/* .text {
  ...
  background: linear-gradient(135deg, #9400D3 0%, #4B0082 17%,
      #0000FF 34%, #00FF00 51%, #FFFF00 68%, #FF7F00 85%, #FF0000 100%);
  background-size: 400%;
