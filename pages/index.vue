<template>
  <div class="intro py-12 px-10 sm:py-7 sm:px-40">
    ...
    <h3 class="text-[22px] sm:text-[34px] pt-4">My name is <span class="font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#00dc82] to-[#36e4da]">Tejas Magade</span></h3>
  </div>
</template>
